 ...
 *
 *      this monster just adds convenient shortcuts for setting number to the display.nothing fancy but works fine.
 *
 *      might add character support, if you're lucky
 */
